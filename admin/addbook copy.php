...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'save') {
    ...
    // --- INSERT NEW BOOK ONLY ---
    $sql = "INSERT INTO books (book_title, authors, isbn, genre, language, total_copies, total_pages, accessor_no, call_number, copyright, volume, edition, publish_year, publisher, description) 
            VALUES ('$title', '$authors', '$isbn', '$genre', '$language', '$copies', '$pages',  '$accessor_no', '$callNo', '$copyright', '$volume', '$edition', '$year', '$publisher', '$desc')";

    if ($conn->query($sql) === TRUE) {
        // --- SUCCESS MESSAGE LOGIC ---
        // We use JavaScript here to show an alert before redirecting
        echo "<script>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group"><label>Genre/Category</label>
                                <select name="genre" id="genre">
                                    ...
                                    <option value="Narrative Report">NarrativeReport</option>
                                </select>
                            </div>
