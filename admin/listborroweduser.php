...
if (!empty($search)) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (!empty($startDate) && !empty($endDate)) {
            ...
            $dateCondition = " AND b.borrow_date BETWEEN '$startDate 00:00:00' AND '$endDate 23:59:59' ";
        }
                        ...
                        <div class="book-info">
                            ...
                            <?php if (!empty($startDate) && !empty($endDate)): ?>
                                <p style="margin-top:5px; font-size:12px;">
                                    ...
                                    Filtering from <b><?= date('M d, Y', strtotime($startDate)) ?></b> to <b><?= date('M d, Y', strtotime($endDate)) ?></b>
                                </p>
                            <?php endif; ?>
                        </div>
