...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['send_otp'])) {
        ...
        $check = $conn->query("SELECT * FROM studacc WHERE email = '$email'");
    ...
    if (isset($_POST['change_password'])) {
        ...
        $checkOld = $conn->query("SELECT password FROM studacc WHERE email = '$email'");
        ...
        // 5. Update Database
            ...
            $sql = "UPDATE studacc SET password = '$new_pass' WHERE email = '$email'";
            
            if ($conn->query($sql)) {
                session_destroy();
                echo "<script>alert('Password changed successfully!'); window.location.href='studentlogin.php';</script>";
            } else {
...
<body>
    ...
    <div class="login-card">
        ...
        <div class="login-right">
            ...
            <div class="back-home">
                <a href="studentlogin.php"><i class="fas fa-arrow-left"></i> Back to Login</a>
            </div>
        </div>
    </div>
